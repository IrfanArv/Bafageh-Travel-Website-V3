...
<header class="main-header">
    ...
    <a href="<?php echo base_url(). 'backend/dashboard'; ?>" class="logo">
      ...
      <span class="logo-mini">B<b>G</b></span>
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg">BAFAGEH <b>GROUP</b></span>
    </a>
      ...
      <div class="navbar-custom-menu">
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              <img src="<?php echo base_url().'assets/images/users/'.$c['photo'];?>" class="user-image" alt="">
            ...
            <ul class="dropdown-menu">
              ...
              <div class="pull-left">
                  <a href="<?php echo base_url().'backend/pengguna/profile/'.$c['idadmin']?>" class="btn btn-default btn-flat">Profile</a>
                </div>
