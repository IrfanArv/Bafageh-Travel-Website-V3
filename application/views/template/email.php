						...
						<tr>
										...
										<tr>
											<td height="25" valign="middle" align="left">
												...
												<table width="160" align="left" cellspacing="0" cellpadding="0" border="0" class="full-width">
													<tbody>
														<tr> 
															<td height="" valign="middle" align="center" class="center-stack" ><a href="//bafageh.com"><img src="<?php echo base_url().'assets/images/mylogo.png' ?>" width="80" height="80" alt="Bafageh Group" /></a></td>
														</tr>
													</tbody>
												</table>
												<!-- End Logo -->
													...
													<tbody>
														<tr>
															<td height="34" valign="bottom" align="right" class="center">
																<a style="text-decoration: none; border:0;" href="//www.instagram.com/bafagehtourand/"><img src="<?php echo base_url().'assets/images/ig.png' ?>" width="27" height="27" alt="Instagram" /></a>
                            ...
                            <!-- Start Space====================== -->
							  ...
							  <table bgcolor="#ffffff" width="100%" cellspacing="0" cellpadding="0" border="0" class="full-width">
												<tbody>
													<tr>
														<td valign="top" align="left"><a href="#"><img src="cid:assets/images/bg01.png" class="emailImage" alt="Main banner" border="0" width="600" height="320" /></a></td>
													</tr>
												</tbody>
							  </table>
								<!-- Section img principale=============== -->
																		...
																		<td align="center">
																			...
																			<table width="100%" align="center" cellspacing="0" cellpadding="0" border="0" class="full-width" >
																				<tbody>
																					...
																					<tr>
																						<td class="font_fix" style="font-size:16px; mso-line-height-rule:exactly; line-height:20px; color:#555555; font-weight:bold; font-family: 'Montserrat', sans-serif;" align="center"><strong style="font-size:20px; text-transform:uppercase;">Dear,</strong> <?php echo $judul;?><br />
                                                                                        <?php echo $hotel_alamat;?></td>
																					</tr>
																					<tr>
																						<td height="20" style="line-height:20px; " ></td>
																					</tr>
																					<tr >
																						<td style="font-size:14px; mso-line-height-rule:exactly; line-height:18px; color:#95a5a6; font-weight:normal; font-family: Arial, Helvetica, sans-serif;" align="center">The hotel voucher has been published
please download this email attachment</td>
																					</tr>
																					...
																					<tr>
																						<td align="center">
																							<table cellspacing="0" cellpadding="0" border="0" align="center">
																								<tbody>
																						<tr>
																						<td style="font-size:14px; mso-line-height-rule:exactly; line-height:18px; color:#95a5a6; font-weight:normal; font-family: Arial, Helvetica, sans-serif;" align="center">Best regards,</td>
																					</tr>
                                                                                    <tr>
																						<td style="font-size:14px; mso-line-height-rule:exactly; line-height:18px; color:#95a5a6; font-weight:normal; font-family: Arial, Helvetica, sans-serif;" align="center"><?php echo $nama;?>, Bafageh Hotel</td>
																					</tr>
																								</tbody>
																							</table>												
																						</td>
                              ...
                              <!-- Start blog posts ================== -->
                               ...
                               <!-- Start footer ================= -->
							  <table width="600" bgcolor="#84760e" align="center" cellspacing="0" cellpadding="0" border="0" class="mobile-width">
												<tbody>
													<tr>	
														<td align="center">														
															<!-- Start Block Content -->
																		...
																		<td valign="top" align="center">
																			...
																			<table align="center" cellspacing="0" cellpadding="0" border="0" class="full-width" width="100%">
																				<tbody>
																					...
																					<tr>
																						<td class="font_fix" style="font-family: 'Montserrat', sans-serif; font-size:28px;mso-line-height-rule:exactly; line-height:28px; font-weight:bold; color:#ffffff;text-decoration:none !important; " align="center">(0251) 8254159</td>
																					</tr>																																						
																					<tr>
																						<td class="font_fix" style="font-size:12px; font-family: 'Montserrat', sans-serif; line-height:14px; color:#ffffff; font-weight:bold; padding-top:5px" align="center"><a href="#" style="color:#ffffff;text-decoration:none !important;">bafageh.hotel@gmail.com</a> - <a href="//bafageh.com" style="color:#ffffff;text-decoration:none !important; ">www.bafageh.com</a></td>
																					</tr>																			
                               ...
                               <!-- Section img footer -->										
							  <table bgcolor="#84760e" width="100%" cellspacing="0" cellpadding="0" border="0" class="full-width">
												<tbody>
													<tr>
														<td valign="bottom" align="left" height="71"><img src="<?php echo base_url().'assets/images/banner_bg.png' ?>" class="emailImage" alt="Main banner" border="0" width="600" height="71" /></td>
													</tr>
												</tbody>
											</table>
								<!-- Section img footer  -->
													...
													<tr>	
														<td align="center">														
															...
															<table width="550" align="center" cellspacing="0" cellpadding="0" border="0" class="content-width">
																<tbody>
																	<tr>
																		<td  align="center" valign="middle" style="font-family: Arial, Helvetica, sans-serif;font-size:11px; font-weight:normal; color:#cccccc; padding-top:10px; padding-bottom:10px"><strong>Copyright <?php echo date('Y');?> Bafageh Group</strong><br />
																		 </td>
																	</tr>
																</tbody>
															</table>
