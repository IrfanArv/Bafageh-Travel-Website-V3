			...
			<div class="row">
					...
					<div class="form_title">
						...
						<table class="table confirm">
							<tbody>
								...
								<tr>
									<td><strong> Total Of Room Night</strong>
									</td>
									<td>
								...
								<tr>
									<td><strong>Number Of Night</strong>
									</td>
									<td><?php echo $jml_kamar . ' Night';?>
									</td>
								</tr>

								<tr>
									<td><strong>Number Of Guest</strong>
									</td>
								...
								<tr>
									...
									<td><?php echo 'Rp '.number_format($hj_we); ?>
									</td>
								</tr>
				...
				<aside class="col-md-4">
                    ...
                    ?>
                        ...
                        ?>
						<a class="btn_full_outline" href="<?php echo base_url().'hotel/finish/'.$idmetode;?>" target="_blank">View your invoice</a>
                        <?php endforeach ?>
                    </div>
