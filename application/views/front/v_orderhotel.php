...
<div id="myModal" class="modal fade" role="dialog">
  ...
  <main>
  		<div id="position">
  			<div class="container">
  				<ul>
  					...
  					<li><a href="<?php echo base_url().'hotels/'.$b['hotel_slug'];?>"><?php echo $b['judul']; ?></a>
  					</li>
  					<li>Hotel Orders</li>
  				</ul>
  			</div>
  		...
  		<div class="container margin_60">
            ...
            <form action="<?php echo base_url().'hotel/order'?>" method="post">
                    ...
                    <input id="email" type="email" name="email" class="form-control" placeholder="*Required" required>
  						...
  						<div class="row">
  							<div class="col-md-6 col-sm-6">
  								<div class="form-group">
                    <label for="jenkel"><i class="icon-person"></i> Gender</label>
            ...
            <div class="form_title">
  						<h3><strong>2</strong>Order Details</h3>
  						<p>
                ...
                <div class="col-md-6 col-sm-6">
                  <div class="form-group">
                    <label><i class="fa fa-bed"></i> Your Room</label>
                    <input type="hidden" name="id_room" class="form-control" value="<?php echo $b['id_room']?>" />
                    <input type="text" name="room" class="form-control" value="<?php echo $b['title']?>"  readonly="readonly" required/>
                  </div> 
                </div>
                <div class="col-md-6 col-sm-6">
                  <div class="form-group">
                    <label><i class="icon-hospital"></i> Your Hotel</label>
                    <input type="hidden" name="id_hotel" class="form-control" value="<?php echo $b['id_hotel']?>" />
                    <input type="text" name="hotel" class="form-control" value="<?php echo $b['judul']?> <?php echo $b['rate']?> "  readonly="readonly" required/>
                  </div> 
                </div>   
                <div class="col-md-6 col-sm-6">
                  <div class="form-group">
                    <label  for="checkin"><i class="icon-calendar-7"></i> Check In</label>
                    <input type="text" name="checkin" id="checkin"  class="date-pick form-control" data-date-format="D, dd M yyyy" required>
                  </div>
                </div> 

								<div class="col-md-6 col-sm-6">
                  <div class="form-group">
                    <label  for="checkout"><i class="icon-calendar-7"></i> Check Out</label>
                    <input type="text" name="checkout" id="checkout"  class="date-pick form-control" data-date-format="D, dd M yyyy" required>
                  </div>
                </div>   

								<div class="col-md-3 col-sm-3">
                  <div class="form-group">
                    <label  for="checkin"><i class="icon-adult"></i> Adult</label>
                    <div class="numbers-row">
                      <input for="adultamt" type="text" id="adultamt" name="adultamt" value="1"  min="1"  require class="qty2 form-control" >
                  	</div>
									</div>
                </div>    
									...
									<div class="col-md-3 col-sm-3">
                  <div class="form-group">
                    <label  for="checkin"><i class="icon-child"></i> Kids</label>
                    <div class="numbers-row">
                      <input for="kids" type="text" id="kids" name="kids" value="0"  min="0"  require class="qty2 form-control" >
                  	</div>
									</div>
                </div>            
                ...
                <div class="col-md-6 col-sm-6">
                  <div class="form-group">
                    <label></i>Numbers Of Room </label>
                    <div class="numbers-row">
                      <input for="totalroom" type="text" id="totalroom" name="totalroom" value="1"  min="1"  require class="qty2 form-control" >
                    </div>
                  </div>
