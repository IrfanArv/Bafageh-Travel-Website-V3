                ...
                <tbody>
                    ...
                    $no=0;
                        foreach($data->result_array() as $a):
                            ...
                            $id=$a['id_faq'];
                            $title=$a['title'];
                            $content=limit_words($a['content'],20);
                    ?>
                <tr>
...
<div class="modal fade" id="largeModal" tabindex="-1" role="dialog" aria-labelledby="largeModal" aria-hidden="true">
    ...
    <form class="form-horizontal" method="post" action="<?php echo base_url().'backend/faq/simpan'?>" enctype="multipart/form-data">
...
<div class="modal fade" id="ModalUpdate<?php echo $id;?>" tabindex="-1" role="dialog" aria-labelledby="largeModal" aria-hidden="true">
    ...
    <form class="form-horizontal" method="post" action="<?php echo base_url().'backend/faq/update'?>" enctype="multipart/form-data">
        <div class="modal-body">
        <div class="form-group">
          ...
          <div class="form-group">
          <div class="col-xs-12">
              <textarea class="ckeditor" name="content" rows="10" cols="10"><?php echo $isi;?></textarea>
          </div>
            </div>
        ...
        <div class="modal fade" id="ModalHapus<?php echo $id;?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <form class="form-horizontal" action="<?php echo base_url().'backend/faq/hapus'?>" method="post" enctype="multipart/form-data">
                    <div class="modal-body">       
							       <input type="hidden" name="kode" value="<?php echo $id;?>"/> 
                          <p>Apakah Anda yakin mau menghapus Syarat ini?</p>
  ...
  $(function () {
    ...
    <?php if($this->session->flashdata('msg')=='success'):?>
        <script type="text/javascript">
                $.toast({
                    heading: 'Success',
                    text: "Ketentuan Berhasil disimpan ke database.",
    ...
    <?php elseif($this->session->flashdata('msg')=='info'):?>
        <script type="text/javascript">
                $.toast({
                    heading: 'Info',
                    text: "Ketentuan berhasil di update",
                    showHideTransition: 'slide',
                    icon: 'info',
                    hideAfter: false,
                    position: 'bottom-right',
