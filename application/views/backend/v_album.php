    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Album Villa</li>
      </ol>
    </section>
            ...
            <div class="box-body">
              <table id="example1" class="table table-striped" style="font-size:13px;">
                ...
                <tbody>
                    ...
                    ?>
                <tr>
                  <td><img class="img-thumbnail" width="90" height="80" src="<?php echo base_url().'assets/images/galleri/'.$cover; ?>"></td>
...
<div class="modal fade" id="largeModal" tabindex="-1" role="dialog" aria-labelledby="largeModal" aria-hidden="true">
    ...
    <div class="modal-header">
        ...
        <h3 class="modal-title" id="myModalLabel">Tambah Villa</h3>
    </div>
