    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active"> Galleri Paket</li>
      </ol>
    </section>
        ...
        <div class="col-xs-12">
          ...
          <div class="box">
            <div class="box-header">
              <a class="btn btn-success btn-flat" data-toggle="modal" data-target="#largeModal"><span class="fa fa-plus"></span> Tambah Koleksi Photo Paket</a>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
          ...
          <tbody>
                    ...
                    ?>
                <tr>
                  <td><img class="img-thumbnail" width="90" height="80" src="<?php echo base_url().'assets/images/paket/galeri_paket/'.$gambar; ?>"></td>
...
<div class="modal fade" id="largeModal" tabindex="-1" role="dialog" aria-labelledby="largeModal" aria-hidden="true">
    ...
    <div class="modal-header">
        ...
        <h3 class="modal-title" id="myModalLabel">Tambah Galleri Paket</h3>
    </div>
    <form class="form-horizontal" method="post" action="<?php echo base_url().'backend/galeri_paket/simpan_galeri'?>" enctype="multipart/form-data">
...
<div class="modal fade" id="ModalUpdate<?php echo $id;?>" tabindex="-1" role="dialog" aria-labelledby="largeModal" aria-hidden="true">
    ...
    <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">x</button>
        <h3 class="modal-title" id="myModalLabel">Update Galleri Paket</h3>
    </div>
    <form class="form-horizontal" method="post" action="<?php echo base_url().'backend/galeri_paket/update_galeri'?>" enctype="multipart/form-data">
        <div class="modal-body">
        ...
        <div class="modal fade" id="ModalHapus<?php echo $id;?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <form class="form-horizontal" action="<?php echo base_url().'backend/galeri_paket/hapus_galeri'?>" method="post" enctype="multipart/form-data">
                    <div class="modal-body">
							       <input type="hidden" name="kode" value="<?php echo $id;?>"/>
                          <p>Apakah Anda yakin mau menghapus Photo dari <b><?php echo $nama_paket;?></b> ?</p>
