    ...
    <section class="content">
      ...
      <div class="col-md-3 col-sm-6 col-xs-12">
          <div class="info-box">
            ...
            <?php 
                    $query=$this->db->query("SELECT * FROM orders WHERE DATE(tanggal) =CURDATE();");
                    $jml=$query->num_rows();
              ?>
            <div class="info-box-content">
              <span class="info-box-text">Paket Hari Ini</span>
              <span class="info-box-number"><?php echo $jml;?> Transaksi</span> 
        ...
        <div class="col-md-3 col-sm-6 col-xs-12">
          <div class="info-box">
            <span class="info-box-icon bg-aqua"><i class="fa fa-hospital-o"></i></span>
              <?php 
                  $query=$this->db->query("SELECT * FROM hotel_orders WHERE DATE(tanggal) =CURDATE();");
                  $jml=$query->num_rows();
              ?>
            <div class="info-box-content">
              <span class="info-box-text">Hotel Hari Ini</span>
              <span class="info-box-number"><?php echo $jml;?> Transaksi</span>
              <span class="info-box-text"><a href="<?php echo base_url().'backend/konfirmasi'?>"> Lihat</span></a>
            </div>
            <!-- /.info-box-content -->
          </div>
          <!-- /.info-box -->
        ...
        <div class="col-md-3 col-sm-6 col-xs-12">
          <div class="info-box">
            <span class="info-box-icon bg-red"><i class="fa fa-bed"></i></span>
              <?php 
                  $query=$this->db->query("SELECT * FROM hotel_bookings WHERE DATE(tanggal) =CURDATE();");
                  $jml=$query->num_rows();
              ?>
            <div class="info-box-content">
              <span class="info-box-text">Hotel Web Hari ini</span>
              <span class="info-box-number"><?php echo $jml;?> Transaksi</span>
              <span class="info-box-text"><a href="<?php echo base_url().'backend/konfirmasi'?>"> Lihat</span></a>
            </div>
            <!-- /.info-box-content -->
        ...
        <div class="col-md-3 col-sm-6 col-xs-12">
          <div class="info-box">
            ...
            <div class="info-box-content">
              ...
              <span class="info-box-number"><?php echo $jml;?> Pesan</span>
        ...
        <div class="col-md-4">
          ...
          <div class="info-box bg-blue">
           ...
           <div class="info-box bg-green">
            ...
            <?php 
                    $query=$this->db->query("SELECT * FROM paket WHERE kategori_id=1");
                    $jml=$query->num_rows();
              ?>
            <div class="info-box-content">
              <span class="info-box-text">Paket Bali</span>
              <span class="info-box-number"><?php echo number_format($jml);?></span>
          ...
          <div class="info-box bg-aqua">
            <span class="info-box-icon"><i class="fa fa-suitcase"></i></span>
            <?php 
                    $query=$this->db->query("SELECT * FROM paket WHERE kategori_id=2");
                    $jml=$query->num_rows();
              ?>
            <div class="info-box-content">
              <span class="info-box-text">Paket Lombok</span>
              <span class="info-box-number"><?php echo number_format($jml);?></span>
