...
<div class="modal fade" id="largeModal" tabindex="-1" role="dialog" aria-labelledby="largeModal" aria-hidden="true">
    ...
    <form class="form-horizontal" method="post" action="<?php echo base_url().'backend/prestasi/simpan_prestasi'?>" enctype="multipart/form-data">
        <div class="modal-body">
            ...
            <div class="form-group">
                <label class="control-label col-xs-2" >Prestasi</label>
                <div class="col-xs-8">
                    <input name="title" class="form-control" type="text" placeholder="Prestasi ..." required>
                </div>
            </div>
...
<div class="modal fade" id="ModalUpdate<?php echo $id;?>" tabindex="-1" role="dialog" aria-labelledby="largeModal" aria-hidden="true">
    ...
    <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">x</button>
        <h3 class="modal-title" id="myModalLabel">Update Prestasi</h3>
    </div>
    <form class="form-horizontal" method="post" action="<?php echo base_url().'backend/prestasi/update_prestasi'?>" enctype="multipart/form-data">
        <div class="modal-body">
            ...
            <div class="form-group">
                <label class="control-label col-xs-2" >Prestasi</label>
                <div class="col-xs-8">
                    <input name="title" value="<?php echo $title;?>" class="form-control" type="text" placeholder="Prestasi..." required>
                </div>
            </div>
        ...
        <div class="modal fade" id="ModalHapus<?php echo $id;?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <form class="form-horizontal" action="<?php echo base_url().'backend/prestasi/hapus_prestasi'?>" method="post" enctype="multipart/form-data">
                    <div class="modal-body">
							       <input type="hidden" name="kode" value="<?php echo $id;?>"/>
